...
/update_projects - изменит что-нибудь в твоем проекте
/delete - поможет тебе удалить какие-нибудь проекты
/projects - покажет твои проекты
/skills - добавит навыка для проекта
/start - газуем
....
...
def addtask_command(message):
    ...
    bot.register_next_step_handler(message, name_project)#Присылает след хэндлер
...
#Команда, если отправлю что-то левое
